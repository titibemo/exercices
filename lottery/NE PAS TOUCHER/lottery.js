"use strict"
   ...
   button.addEventListener("click", musicBg)
 ...
 function tirage(){
    ...
    if(rep<itr){
       ...
       if(index==6){
          ...
          p.textContent = "Merci d'avoir joué, nous vous souhaitons un joyeux noël et à très bient-oh-oh-oh pour un nouveau tirage"
